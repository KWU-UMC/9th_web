...
const MovieCard = ({movie} : MovieCardProps) => {
    ...
    return (
        <>
            <li className="relative group cursor-pointer rounded-xl shadow-lg w-44 transition-transform duration-500 hover:scale-105" key={movie.id} onMouseEnter={():void => setIshover(true)} onMouseLeave={():void=>setIshover(false)}>
